...
from keras.layers import Conv2D, MaxPooling2D, UpSampling2D, Concatenate, Flatten, Dense
...
def create_fcn00(input_size):
    ...
    pool4 = AveragePooling2D(pool_size=(2, 2), data_format='channels_first')(conv4)
    ...
    pool5 = AveragePooling2D(pool_size=(2, 2), data_format='channels_first')(conv5)
